    ...
    <div ref={containerRef} className="relative bg-black text-white">
      ...
      >
        ...
        >
          ...
          <h2 className="text-xl md:text-2xl bg-white bg-clip-text text-transparent font-semibold mb-6">
            Private Events, Impeccably Tailored to Your Story
          </h2>
          <p className="bg-white bg-clip-text text-transparent text-lg md:text-xl leading-relaxed mb-10">
